...
class SelectModeButton extends StatelessWidget {
  ...
  // 생성자에서 콜백을 받아옵니다.
  const SelectModeButton({Key? key, required this.onExitClosetScreen}) : super(key: key);
            ...
            CupertinoButton(
              ...
              onPressed: () async {
                if (selectionProvider.hasSelection) {
                  ...
                  final confirmationProvider = Provider.of<ClothingConfirmationProvider>(context, listen: false);
